...
$mess=$_GET["mess"] ?? null;
$statement=$pdo->prepare("SELECT * FROM newspapers");
$statement->execute();
                            ...
                            <div class="card-body">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $i+1 ?></td>
                                            <td><img style = "height:100px; width:100px; border-radius:100px;" src="<?php echo "../vendor/".$newspaper["newspapers_Image"]?>" alt="" srcset=""></td>
