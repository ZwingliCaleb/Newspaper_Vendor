                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <a href="vendor_edit.php?id=<?php echo $vendor["vendor_id"]?>" class="btn btn-primary">Edit</a> 
                                            <a href="vendor_del.php?id=<?php echo $vendor["vendor_id"]?>"class="btn btn-danger">Delete</a> 
                                            </td>
                                        </tr>
                                       <?php } endforeach; ?>
                                    </tbody>
