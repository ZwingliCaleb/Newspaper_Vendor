                ...
                <main>
                   ...
                   <?php include_once "../admin/includes/message.php"?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-secondary text-white mb-4">
                                    <div class="card-body">Countries</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="country.php">View</a>
                                        <div class="small text-white fas fa-eye"><i class="fas fa-eye"></i></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-secondary text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="all_vens.php">View</a>
                                        <div class="small text-white fas fa-eye"><i class="fas fa-eye"></i></div>
                                    </div>
                                </div>
                            </div>
